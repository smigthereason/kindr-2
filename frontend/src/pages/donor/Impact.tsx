...
const Impact: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black ml-64 w-5/6 text-white">
      <main className="p-8">
        <h1 className="text-4xl mb-2">Let's Make Education For All</h1>
        <h2 className="text-2xl mb-8 text-orange-500">Kindr Donation Platform</h2>

        <section className="ml-22 bg-black text-white">
          <Charities />
        </section>

        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 relative top-4">
          <div className="flex flex-col">
            <section className="mt-6">
              <div className="flex space-x-4 mb-4 text-3xl">
