...
type SetDataFunction = React.Dispatch<React.SetStateAction<LoginData | SignupData>>;
...
const Login: React.FC<LoginProps> = ({ setUser }) => {
  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError('Signup failed: ' + (error.response?.data?.message || 'An unexpected error occurred'));
    }
  };
            ...
            <form onSubmit={handleLogin}>
              <div className="input-container">
                ...
                <input
                  ...
                  onChange={(e) => handleChange(e, setLoginData as SetDataFunction, false)}
                  required
                />
              </div>
              <div className="input-container">
            ...
            <form onSubmit={handleSignup}>
              <div className="input-container">
                ...
                <input
                  ...
                  onChange={(e) => handleChange(e, setSignupData as SetDataFunction, true)}
                  required
                />
              </div>
              <div className="input-container">
