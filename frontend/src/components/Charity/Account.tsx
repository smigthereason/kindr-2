const Account = () => {
    return (
      <div className="bg-secondary rounded-lg shadow-stone-500 min-h-screen pt-2 font-mono my-16 w-4-6">
            ...
            <form className="mt-6 border-t border-gray-400 pt-4">
              <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full md:w-full px-3 mb-6">
                  ...
                  <div className="flex-shrink w-full inline-block relative">
                    <select className="block appearance-none text-gray-200 w-full border border-gray-900 shadow-inner px-4 py-2 pr-8 rounded bg-black">
                      <option>choose ...</option>
